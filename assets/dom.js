...
function cantidadCuotasPermitida (cuotasTres,cuotasSeis,cuotasDoce,credito,getEventos){                          // te dice en cuantas cuotas podes sacar el prestamo . si el monto de la cuota supera mas del 20% no lo podes sacar en esa cantidad de cuotas    
    ...
    if ((cuotasTres==true) && (cuotasSeis==true) && (cuotasDoce==true)) {                                 // en todas las cuotas disposibles 3 , 6 o 12 
        getEventos.innerHTML = ` <h2 class="mostrar_busqueda posicion_texto">Usted lo puede realizar en 3 , 6 o 12 cuotas  </h2>        
        ...
        <label for="cuotas2" class="labelForms">Escriba si en 6 o 12 cuotas: </label>
...
function cargarArreglo() {
    ...
    getBotonCrear.onclick = (e)=>{                                                                      // evento clickear crear credito   , pide nombre y sueldo 
        ...
        <label for="sueldoC" class="labelForms">Salario:</label>
        ...
        getform1.onsubmit = (e)=>{
            ...
            if (validarSueldo && validarNombre) {                  
                ...
                maxCredito = sueldo * 2 ;
                getEventos.innerHTML = ` <h2 class="mostrar_busqueda posicion_texto"> El monto Maximo que puede solicitar es de: $${maxCredito} </h2>        
...
function filtrarArreglo(){                                                                                  // filtra arreglos por cantidad de monto , si son superiores al monto los muestra en pantalla
    ...
    getBotonFiltrar.onclick = (e) =>{
        ...
        getfiltrarIn.addEventListener('input', (e)=>{
            ...
            validarMontoFiltrar?errorSpanFiltrar.style.display='none':errorSpanFiltrar.style.display='block';                                           // muestra el spam Error si hay un valor incorrecto en el input 
        });
...
function mostrarCreditosFin(){                         // muestra los creditos de la, por asi decirlo, base de datos json creada como ejemplo
    
    fetch('./assets/datos/creditos.json')                      // pide los datos en el json local 
